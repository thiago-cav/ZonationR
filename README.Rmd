...
* **Enable reproducibility** through transparent script-based workflows that remain fully consistent with the original Zonation software.
...
knitr::include_graphics("man/figures/zonationr-workflow.png")
```
