...
In this tutorial, we use the [Zonation5RData](https://github.com/kguidonimartins/Zonation5RData) package, which provides GeoTIFF layers for workflows with Zonation and *ZonationR*. To use the layers in the **RStudio project**, we first create folders and then copy the raster files from the package.
