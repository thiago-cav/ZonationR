...
For this example, we use the [Zonation5RData](https://github.com/kguidonimartins/Zonation5RData) package, which provides GeoTIFF layers for workflows with Zonation and *ZonationR*. To use the biodiversity layers in the **RStudio project**, we first create a folder and then copy the raster files from the package.
